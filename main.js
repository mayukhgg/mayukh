/* ---------- TYPING ANIMATION ---------- */
const words = ["Web Developer","Full Stack Developer","Web Designer","Programmer","Student"];
let wordIndex = 0, charIndex = 0, isDeleting = false;
const typingSpan = document.querySelector(".typing-text span");

function type() {
  const currentWord = words[wordIndex];
  if (!isDeleting) typingSpan.textContent = currentWord.substring(0, charIndex++);
  else typingSpan.textContent = currentWord.substring(0, charIndex--);
